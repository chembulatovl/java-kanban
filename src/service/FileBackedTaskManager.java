...
public class FileBackedTaskManager extends InMemoryTaskManager {
    ...
    public static void main(String[] args) {
        ...
        Task task1 = new Task("Задача 1", "Описание задачи 1",
                LocalDateTime.of(2025, 1, 20, 10, 0), Duration.ofMinutes(100));
        Task task2 = new Task("Задача 2", "Описание задачи 2",
                LocalDateTime.of(2025, 1, 20, 12, 0), Duration.ofMinutes(100));
        ...
        Subtask subtask1 = new Subtask("Подзадача 1", "Описание подзадачи 1", epic1.getId(),
                LocalDateTime.of(2025, 1, 20, 14, 0), Duration.ofMinutes(100));
        Subtask subtask2 = new Subtask("Подзадача 2", "Описание подзадачи 2", epic1.getId(),
                LocalDateTime.of(2025, 1, 20, 16, 30), Duration.ofMinutes(100));
        Subtask subtask3 = new Subtask("Подзадача 3", "Описание подзадачи 3", epic1.getId(),
                LocalDateTime.of(2025, 1, 20, 19, 00), Duration.ofMinutes(100));
